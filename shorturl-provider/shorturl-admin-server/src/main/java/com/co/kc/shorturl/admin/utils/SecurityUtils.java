package com.co.kc.shorturl.admin.utils;
...
public class SecurityUtils {
     ...
     * @return 返回值
     */
    public static String echoToken(SecurityAuth jwtObject) {
    ...
    public static SecurityAuth parseToken(String token) {
        ...
        try {
            ...
            return JSON.parseObject((String) claims.get(KEY_BODY), SecurityAuth.class);
