...
import com.co.kc.shorturl.common.processor.annotation.Lock;
import com.co.kc.shorturl.common.sdk.helper.LockHelper;
...
public class LockAspect {
    ...
    @Pointcut("@annotation(com.co.kc.shorturl.common.processor.annotation.Lock)")
